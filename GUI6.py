...
import bridge
from ProfDialog6 import ProfileDialog
...
class MainWindow(QMainWindow):
    def __init__(self, flag=False):
        ...
        self.buttonBox.setStandardButtons(QMessageBox.StandardButton.Ok | QMessageBox.StandardButton.Cancel)
        ...
        zrame = QFrame()
        zrame.resize(1, 1)
        zrame.setFrameShadow(QFrame.Shadow.Plain)
        zrame.setFrameShape(QFrame.Shape.Box)
        zrame.setStyleSheet("border: 2px solid black;")

        yrame = QFrame()
        yrame.resize(1, 1)
        yrame.setFrameShadow(QFrame.Shadow.Plain)
        yrame.setFrameShape(QFrame.Shape.Box)
        yrame.setStyleSheet("border: 2px solid blue;")

        xrame = QFrame()
        xrame.resize(1, 1)
        xrame.setFrameShadow(QFrame.Shadow.Plain)
        xrame.setFrameShape(QFrame.Shape.Box)
        ...
        self.freq.setAlignment(Qt.AlignmentFlag.AlignCenter)
        self.freq.setMaximumHeight(50)
        # self.freq2 = QLabel('', self)
        # self.freq2.setAlignment(Qt.AlignmentFlag.AlignCenter)
        ...
        self.freq3.setAlignment(Qt.AlignmentFlag.AlignCenter)
        self.freq3.setMaximumHeight(50)
        # self.freq4 = QLabel('ClockSpeed worker3', self)
        # self.freq4.setAlignment(Qt.AlignmentFlag.AlignCenter)
    ...
    def open_profile_management(self):
        ...
        # .exec() opens the window and freezes code execution right here
        # until the user closes or clicks a button inside ProfileDialog
        result = dialog.exec()

        # Check if they clicked 'Select' or closed it
        if result == QDialog.DialogCode.Accepted:  # Adjusted for PyQt6 syntax
