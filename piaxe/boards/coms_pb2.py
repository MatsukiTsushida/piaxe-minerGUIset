...
DESCRIPTOR = _descriptor.FileDescriptor(
  ...
  serialized_pb=b'\n\ncoms.proto\"0\n\x08QRequest\x12\n\n\x02id\x18\x01 \x01(\x05\x12\n\n\x02op\x18\x02 \x01(\x05\x12\x0c\n\x04\x64\x61ta\x18\x03 \x01(\x0c\"4\n\tQResponse\x12\n\n\x02id\x18\x01 \x01(\x05\x12\r\n\x05\x65rror\x18\x02 \x01(\x05\x12\x0c\n\x04\x64\x61ta\x18\x03 \x01(\x0c\"9\n\x08QControl\x12\x11\n\tstate_1v2\x18\x01 \x01(\x05\x12\x0c\n\x04pwm1\x18\x02 \x01(\x05\x12\x0c\n\x04pwm2\x18\x03 \x01(\x05\"\x8f\x02\n\x06QState\x12\x11\n\tpgood_1v2\x18\x01 \x01(\x05\x12\r\n\x05temp1\x18\x02 \x01(\x05\x12\r\n\x05temp2\x18\x03 \x01(\x05\x12\x14\n\x0csys_voltages\x18\x04 \x01(\x05\x12\x16\n\x0ehb1_temp_pair1\x18\x05 \x01(\x05\x12\x16\n\x0ehb1_temp_pair2\x18\x06 \x01(\x05\x12\x16\n\x0ehb1_temp_pair3\x18\x07 \x01(\x05\x12\x16\n\x0ehb1_temp_pair4\x18\x08 \x01(\x05\x12\x16\n\x0ehb2_temp_pair1\x18\t \x01(\x05\x12\x16\n\x0ehb2_temp_pair2\x18\n \x01(\x05\x12\x16\n\x0ehb2_temp_pair3\x18\x0b \x01(\x05\x12\x16\n\x0ehb2_temp_pair4\x18\x0c \x01(\x05\x62\x06proto3'
)
...
_QSTATE = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='sys_voltages', full_name='QState.sys_voltages', index=3,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='hb1_temp_pair1', full_name='QState.hb1_temp_pair1', index=4,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='hb1_temp_pair2', full_name='QState.hb1_temp_pair2', index=5,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='hb1_temp_pair3', full_name='QState.hb1_temp_pair3', index=6,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='hb1_temp_pair4', full_name='QState.hb1_temp_pair4', index=7,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='hb2_temp_pair1', full_name='QState.hb2_temp_pair1', index=8,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='hb2_temp_pair2', full_name='QState.hb2_temp_pair2', index=9,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='hb2_temp_pair3', full_name='QState.hb2_temp_pair3', index=10,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='hb2_temp_pair4', full_name='QState.hb2_temp_pair4', index=11,
